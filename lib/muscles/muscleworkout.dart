...
class _MyHomePageState extends State<MUSCLE> {
  @override
    ...
    return Scaffold(
        ...
        body: SingleChildScrollView(
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    TextButton(
                      onPressed: _biceps,
                      child: Image.asset('assets/muscle1.jpg'),
                    ),
                    Text(
                        """BICEPS WORKOUT:                                                      """,
                        style: TextStyle(
         ...
         """,
                    ...
                    TextButton(
                        onPressed: _back,
                        child: Image.asset('assets/muscle2.jpg')),
                    Text(
                        """BACK WORKOUT:                                                      """,
                        style: TextStyle(
                            color: Colors.white, fontWeight: FontWeight.bold)),
         ...
         """,
                    ...
                    TextButton(
                        onPressed: _leg,
                        child: Image.asset('assets/muscle3.jpg')),
                    Text(
                        """LEG WORKOUT:                                                      """,
                        style: TextStyle(
                            color: Colors.white, fontWeight: FontWeight.bold)),
         ...
         """,
                    ...
                    TextButton(
                        onPressed: _tricap,
                        child: Image.asset('assets/muscle4.jpg')),
                    Text(
                        """TRICEP WORKOUT:                                                      """,
                        style: TextStyle(
                            color: Colors.white, fontWeight: FontWeight.bold)),
         ...
         """,
                    ...
                    TextButton(
                        onPressed: _chest,
                        child: Image.asset('assets/muscle5.jpg')),
                    Text(
                        """CHEST WORKOUT:                                                      """,
                        style: TextStyle(
                            color: Colors.white, fontWeight: FontWeight.bold)),
         ...
         """,
                    ...
                    TextButton(
                        onPressed: _shoulder,
                        child: Image.asset('assets/muscle6.jpg')),
                    Text(
                        """SHOULDER WORKOUT:                                                       """,
                        style: TextStyle(
                            color: Colors.white, fontWeight: FontWeight.bold)),
